...
@section('title', 'Create News - BG Group')
    ...
    <div class="content">
        <div class="card container-fluid mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Create Catalog</h5>
                ...
                <form class="row" method="POST" action="{{ route('catalog.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="card card-body main-description shadow br-8 p-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control br-8 @error('url') is-invalid @enderror" type="text"
                                    name="url" value="{{ old('url') }}" placeholder="Enter Name">
                                @error('url')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card-body card shadow br-8">
                            ...
                            <hr class="shadow-sm">
                            <label for="image">Featured Icon</label>
                            <div class="custom-file">
                                <!-- File input for selecting an image -->
                                <input class="form-control" id="image_input" type="file" name="image" accept="image/*"
                                    onchange="previewImage()">
                                <div class="upload-media  border d-flex justify-content-center align-items-center mt-3">
