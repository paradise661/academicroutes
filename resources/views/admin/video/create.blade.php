    ...
    <div class="content">
        <div class="card container-fluid mb-4">
            ...
            <div class="card-body p-0">
                <form class="row" method="POST" action="{{ route('videos.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-9 mb-5">
                        <div class="card card-body main-description shadow br-8 p-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control br-8 @error('url') is-invalid @enderror" type="url"
                                    name="url" value="{{ old('url') }}" placeholder="https://">
                                @error('url')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
