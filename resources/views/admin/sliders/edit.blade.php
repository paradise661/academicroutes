...
@section('title', 'Edit ' . $slider->name . ' -BG Group')
        ...
        <div class="card container-fluid mb-4">
            ...
            <div class="card-body p-0 mb-4">
                <form class="row" method="POST" action="{{ route('slider.update', $slider->id) }}"
                    ...
                    <!-- Left Column (Slider Information) -->
                    <div class="col-md-9">
                        <div class="card card-body main-description shadow br-8 p-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control br-8 @error('link') is-invalid @enderror" type="text"
                                    name="link" value="{{ old('link', $slider->link) }}" placeholder="Enter URL">
                                @error('link')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="card-body card shadow br-8">
                            ...
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-5" id="status" name="status">
                                    <option value="0" @if ($slider->status == 0) selected @endif>Draft</option>
                                    <option value="1" @if ($slider->status == 1) selected @endif>Publish
                                    </option>
                                </select>
                            </div>
