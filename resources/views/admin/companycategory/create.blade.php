...
@section('title', 'Create CompanyCategory - BG Group')
    ...
    <div class="content">
        <div class="card container-fluid mb-4">
            ...
            <div class="card-body p-0">
                <form class="row" method="POST" action="{{ route('companycategory.store') }}"
                    ...
                    <div class="col-md-3">
                        <div class="card-body card shadow br-8">
                            ...
                            <div class="custom-file">
                                <input class="form-control" id="icon_input" type="file" name="icon" accept="image/*"
                                    onchange="previewIcon()">
                                <div
                                    class="upload-media border border-2 d-flex justify-content-center align-items-center mt-3">
                                    <div class="thumbnails media-wrapper d-flex justify-content-center align-items-center">
                                        <img class="custom-width" id="icon_img"
                                            src="{{ asset('admin/assets/images/upload.png') }}" alt="upload-icon">
                                    </div>
                                </div>
                            </div>
