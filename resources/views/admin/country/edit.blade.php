...
@section('title', 'Edit ' . $country->name . ' - BG Group')
    ...
    <div class="content">
        <div class="card container-fluid mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit Countries - {{ $country->name }}</h5>
                <small class="text-muted float-end">
                    <a class="btn btn-primary" href="{{ route('country.index') }}"><i class="fa-solid fa-arrow-left"></i>
                        Back</a>
                </small>
            </div>
